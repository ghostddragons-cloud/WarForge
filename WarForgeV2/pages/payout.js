...
const estimateCaches = async () => {
  ...
  return(<>
    ...
    <div style={{minHeight:"100vh",background:th.bg,color:th.bone,fontFamily:"Arial,sans-serif",boxShadow:isSampleActive?"inset 0 0 0 3px #c44040":"none"}}>
      ...
      </div><footer style={{borderTop:`1px solid ${th.cb}`,padding:"12px 20px",marginTop:"30px",textAlign:"center",background:th.hBg}}><div style={{fontSize:"10px",color:th.steel}}><span style={{color:th.gD,fontWeight:700}}>WARFORGE v1.1</span> — Faction Management Suite</div></footer></div></>);
}
